...
const CompaniesPage: React.FC = () => {
  const { companyRows, createName, setCreateName, createPlan, setCreatePlan, editName, setEditName, editPlan, setEditPlan, handleCreateSubmit, handleEditSubmit, openCreateModal, openEditCompany, toggleCompanyActive, planBadgeClass, statusBadgeClass } = useAdminCompanies();
  return (
    <AdminShell>
      <div className="container-fluid" style={{maxWidth: '1200px', padding: '32px 32px 80px'}}>
        ...
        {companyRows.map((company) => (
          <tr key={String(company.company_id)}>
                                      ...
                                      <td><span className={planBadgeClass(company.plan_type)} style={{fontSize: '11px'}}>{company.plan_type}</span></td>
                                      ...
                                      <td><span className={statusBadgeClass(company.active)} style={{fontSize: '11px'}}>{company.active ? 'Active' : 'Suspended'}</span></td>
                                      <td className="pe-3">
                          ...
                          <div className="modal-content rounded-3">
                              ...
                              <form data-cloudey="admin.companies.create_form" onSubmit={handleCreateSubmit}>
                                  <div className="modal-body">
                                      <div className="mb-3"><label className="form-label fw-semibold" style={{fontSize: '13px'}}>Company Name <span className="text-danger">*</span></label><input className="bg-light border form-control form-control-sm d-block w-100" type="text" placeholder="Acme Corp" data-cloudey="admin.companies.create.name" required value={createName} onChange={e => setCreateName(e.target.value)} /></div>
                                      <div className="mb-3"><label className="form-label fw-semibold" style={{fontSize: '13px'}}>Plan</label><select className="bg-light border form-select form-select-sm d-block w-100" data-cloudey="admin.companies.create.plan" required value={createPlan} onChange={e => setCreatePlan(e.target.value)}>
                      ...
                      <div className="modal-dialog modal-dialog-centered" role="document">
                          <div className="modal-content rounded-3">
                              ...
                              <form data-cloudey="admin.companies.edit_form" onSubmit={handleEditSubmit}>
                                  <div className="modal-body">
                                      <div className="mb-3"><label className="form-label fw-semibold" style={{fontSize: '13px'}}>Company Name</label><input className="bg-light border form-control form-control-sm d-block w-100" type="text" placeholder="Acme Corp" data-cloudey="admin.companies.edit.name" required value={editName} onChange={e => setEditName(e.target.value)} /></div>
                                      <div className="mb-3"><label className="form-label fw-semibold" style={{fontSize: '13px'}}>Plan</label><select className="bg-light border form-select form-select-sm d-block w-100 form-control-sm" placeholder="acme.com" data-cloudey="admin.companies.edit.plan" required value={editPlan} onChange={e => setEditPlan(e.target.value)} defaultValue="Pro">
                                              <option value="Free Trial">Free Trial</option>
                                              <option value="Starter">Starter</option>
                                              <option value="Pro">Pro</option>
                                              <option value="Enterprise">Enterprise</option>
